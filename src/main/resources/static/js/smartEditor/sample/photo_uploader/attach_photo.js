...
function html5Upload() {
    ...
    sUploadURL = 'api/image'; 	//upload URL
...
function callAjaxForHTML5(tempFile, sUploadURL) {
            console.log(sUploadURL, tempFile)

            console.log(tempFile)

            const data = new FormData();
            data.append('file', tempFile);
            data.append('name', tempFile.name);
    ...
    // var oAjax = jindo.$Ajax("/api/smarteditorMultiImageUpload", {
    //     type: 'xhr',
    //     method: "post",
...
function callFileUploader() {
    oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"), {
        sUrl: '/api/smarteditorMultiImageUpload',	//샘플 URL입니다.
...
window.onload = function () {
    ...
    fnUploadImage = jindo.$Fn(uploadImage, this);
    jindo.$Fn(closeWindow, this).attach(welBtnCancel.$value(), "click");
};
